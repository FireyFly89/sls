<footer class="footer">
    <div class="footer__wrap">
        <div class="footer__content">
            <h2><?php _e('Looking for something new?', 'sls-website'); ?></h2>
            <p><?php _e('Check out our available offers now!', 'sls-website'); ?></p>
            <a href="<?php echo home_url('/careers'); ?>" class="cta"><?php _e('Careers', 'sls-website'); ?></a>
        </div>
